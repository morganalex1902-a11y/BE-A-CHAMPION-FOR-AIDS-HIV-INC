...
export default function CTASection() {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-secondary via-black to-secondary text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
          {/* Donate Card */}
          <div className="bg-white/10 backdrop-blur-sm border border-primary/30 p-6 rounded-lg hover:bg-white/20 transition-all">
            ...
            <Link
              ...
              className="inline-block px-6 py-2 bg-primary hover:bg-red-700 text-white font-semibold rounded-lg transition-colors"
            >
              Give Now
            </Link>
          </div>
        ...
        <Link
          href="/contact"
          className="inline-block px-8 py-4 bg-white text-primary hover:bg-gray-100 font-bold text-lg rounded-lg transition-all transform hover:scale-105 shadow-lg"
        >
