...
export default function HeroSection() {
  return (
    <section className="relative w-full h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 overflow-hidden">
      {/* Background Image */}
      <Image
        src="/images/hero-community.jpg"
        alt="Community coming together for HIV awareness"
        fill
        className="object-cover opacity-15 absolute inset-0"
      />

      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-20 z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,rgba(227,27,35,0.1),transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_80%,rgba(255,215,0,0.1),transparent_50%)]"></div>
      </div>
      ...
      <div className="relative h-full flex flex-col items-center justify-center px-4 text-center z-20">
        <div className="max-w-3xl mx-auto animate-fade-in">
          ...
          {/* Tagline */}
          <p className="text-sm md:text-base text-gray-700 mb-12 px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              href="/programs"
              className="px-8 py-3 bg-secondary hover:bg-yellow-500 text-gray-900 font-bold rounded-lg transition-all transform hover:scale-105 shadow-lg"
            >
              Join Speak Out Club
            </Link>
            <Link
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce z-30">
          <div className="flex flex-col items-center">
            <p className="text-gray-700 text-xs mb-2">Scroll to explore</p>
