    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {/* Stat Card 1 */}
          <div className="text-center p-8 bg-gray-50 rounded-lg border border-primary/20 hover:shadow-lg transition-shadow">
            <div className="text-5xl font-bold text-primary mb-2">2022</div>
            <p className="text-gray-900 font-semibold">Active Since Registration</p>
          ...
          <div className="text-center p-8 bg-gray-50 rounded-lg border border-primary/20 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-900 font-semibold">Community Members</p>
          ...
          <div className="text-center p-8 bg-gray-50 rounded-lg border border-primary/20 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-900 font-semibold">Inclusive Organization</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
          ...
          <div className="bg-gray-50 p-8 rounded-lg border-l-4 border-primary">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">About BE A CHAMPION</h3>
