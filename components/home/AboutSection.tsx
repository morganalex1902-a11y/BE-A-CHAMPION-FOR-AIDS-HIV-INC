    ...
    <section className="py-16 md:py-24 bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-secondary mb-4">Our Mission</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {/* Stat Card 1 */}
          <div className="text-center p-8 bg-gray-800 rounded-lg border border-secondary/30 hover:shadow-lg hover:border-secondary transition-all">
            <div className="text-5xl font-bold text-secondary mb-2">2022</div>
            <p className="text-gray-200 font-semibold">Active Since Registration</p>
          ...
          <div className="text-center p-8 bg-gray-800 rounded-lg border border-secondary/30 hover:shadow-lg hover:border-secondary transition-all">
            ...
            <p className="text-gray-200 font-semibold">Community Members</p>
          ...
          <div className="text-center p-8 bg-gray-800 rounded-lg border border-secondary/30 hover:shadow-lg hover:border-secondary transition-all">
            ...
            <p className="text-gray-200 font-semibold">Inclusive Organization</p>
