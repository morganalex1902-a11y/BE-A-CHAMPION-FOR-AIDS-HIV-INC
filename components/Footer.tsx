      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-4">EIN: 83-3215091</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/get-involved" className="text-gray-400 hover:text-primary transition-colors">Get Involved</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-400">300 NW 34th Street, Apt. #206<br/>Pompano Beach, FL 33064</p>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-5 h-5 text-primary" />
                <a href="tel:+19547402146" className="text-gray-400 hover:text-primary transition-colors">(954) 740-2146</a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-5 h-5 text-primary" />
                <a href="mailto:beachampaid.hivinc@gmail.com" className="text-gray-400 hover:text-primary transition-colors text-xs">beachampaid.hivinc@gmail.com</a>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500">
          ...
          {showBackToTop && (
            <button
              onClick={scrollToTop}
              className="mt-4 sm:mt-0 flex items-center gap-2 text-primary hover:text-red-500 transition-colors"
            >
              Back to Top
