        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <button
                ...
                className={`p-6 rounded-lg border-2 transition-all transform hover:scale-105 text-center ${
                  activeSection === 'donate'
                    ...
                    : 'bg-white border-gray-200 text-foreground hover:border-primary'
                }`}
              >
                <Heart className={`w-10 h-10 mx-auto mb-3 ${activeSection === 'donate' ? 'text-white' : 'text-primary'}`} />
                <h3 className="font-bold">Donate</h3>
                <p className="text-sm mt-2">Support our mission financially</p>
              </button>
              ...
              >
                <HandHelping className={`w-10 h-10 mx-auto mb-3 ${activeSection === 'volunteer' ? 'text-white' : 'text-primary'}`} />
                <h3 className="font-bold">Volunteer</h3>
                <p className="text-sm mt-2">Give your time and skills</p>
              </button>
              ...
              >
                <Share2 className={`w-10 h-10 mx-auto mb-3 ${activeSection === 'share' ? 'text-white' : 'text-primary'}`} />
                <h3 className="font-bold">Spread Awareness</h3>
                <p className="text-sm mt-2">Share our mission with others</p>
              </button>
              ...
              >
                <TrendingUp className={`w-10 h-10 mx-auto mb-3 ${activeSection === 'events' ? 'text-white' : 'text-primary'}`} />
                <h3 className="font-bold">Events</h3>
                <p className="text-sm mt-2">Attend upcoming events</p>
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white p-8 rounded-lg border-2 border-secondary mb-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground mt-2 ml-8">
                    ...
                    <div className="bg-secondary/10 p-4 rounded-lg border-2 border-secondary">
                      <h3 className="font-bold text-primary mb-3">Your impact:</h3>
              ...
              <div className="animate-fade-in">
                <div className="bg-white p-8 rounded-lg border-2 border-secondary mb-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Interests */}
                    <div>
                      <label className="block text-sm font-semibold text-primary mb-3">Areas of Interest</label>
            ...
            {activeSection === 'share' && (
              <div className="animate-fade-in">
                <div className="bg-white p-8 rounded-lg border-2 border-secondary">
                  <h2 className="text-3xl font-bold text-primary mb-6">Spread Awareness</h2>
                  <p className="text-foreground mb-8">
                  ...
                  <div className="space-y-6">
                    {/* Social Share */}
                    <div>
                      <h3 className="font-bold text-primary mb-4">Share on Social Media</h3>
                    ...
                    {/* Share Text */}
                    <div>
                      <h3 className="font-bold text-primary mb-4">Sample Message</h3>
                      <div className="bg-secondary/10 p-4 rounded-lg border-2 border-secondary">
                    ...
                    <div className="bg-secondary/10 p-6 rounded-lg border-2 border-secondary">
                      <h3 className="font-bold text-primary mb-3">Sign Our Petition</h3>
            ...
            {activeSection === 'events' && (
              <div className="animate-fade-in">
                <div className="bg-white p-8 rounded-lg border-2 border-secondary">
                  <h2 className="text-3xl font-bold text-primary mb-6">Attend Our Events</h2>
                  <p className="text-foreground mb-8">
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="p-4 border-2 border-gray-200 rounded-lg hover:border-primary transition-colors">
                      <h3 className="font-bold text-primary mb-2">Monthly Speak Out Club Meetings</h3>
                      <p className="text-sm text-foreground mb-3">Every 2nd Saturday, 10 AM-12 PM at Community Center</p>
                      <button className="text-primary hover:text-red-700 font-semibold text-sm">
                        Register Now
                      </button>
                    </div>
                    ...
                    <div className="p-4 border-2 border-gray-200 rounded-lg hover:border-primary transition-colors">
                      <h3 className="font-bold text-primary mb-2">South Florida AIDS Walk</h3>
                      <p className="text-sm text-foreground mb-3">April 15, 2026 at Las Olas Boulevard, Fort Lauderdale</p>
                      <button className="text-primary hover:text-red-700 font-semibold text-sm">
                        Learn More & Join
                      </button>
                    </div>
                    ...
                    <div className="p-4 border-2 border-gray-200 rounded-lg hover:border-primary transition-colors">
                      <h3 className="font-bold text-primary mb-2">Community Giveaway Events</h3>
                      <p className="text-sm text-foreground mb-3">Monthly events with free supplies, haircuts, and more</p>
                      <button className="text-primary hover:text-red-700 font-semibold text-sm">
                        View Calendar
                      </button>
                    </div>
